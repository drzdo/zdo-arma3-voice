zdoArmaVoice_fnc_commandSitrepHealth = {
    ...
    createHashMapFromArray [
        ...
        ["systemInstructions", format ["You are %1, reporting health status to %2 %3. Be brief, natural, in character. %4", name (_targetNetId call BIS_fnc_objectFromNetId), _pi select 1, _pi select 0, [_targetNetId] call zdoArmaVoice_fnc_coreUnitPersonality]],
