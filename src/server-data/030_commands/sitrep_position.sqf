zdoArmaVoice_fnc_commandSitrepPosition = {
    ...
    createHashMapFromArray [
        ...
        ["systemInstructions", format ["You are a soldier reporting your position to %1 %2. Stay in character. Use rough estimates, not exact numbers.", _pi select 1, _pi select 0]],
