zdoArmaVoice_fnc_commandSitrepPosition = {
    ...
    createHashMapFromArray [
        ...
        ["systemInstructions", format ["You are %1, a soldier reporting your position to %2 %3. Stay in character. Use rough estimates, not exact numbers. %4", name (_targetNetId call BIS_fnc_objectFromNetId), _pi select 1, _pi select 0, [_targetNetId] call zdoArmaVoice_fnc_coreUnitPersonality]],
